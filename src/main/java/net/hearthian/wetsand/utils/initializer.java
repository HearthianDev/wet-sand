...
public class initializer {
    ...
    public static final Block MOIST_SAND = new WettableFallingBlock(
        ...
        AbstractBlock.Settings.copy(SAND)
    );
    ...
    public static final Block RED_SAND = new WettableFallingBlock(
        Wettable.HumidityLevel.UNAFFECTED,
        AbstractBlock.Settings.create().mapColor(MapColor.ORANGE).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)
    );
